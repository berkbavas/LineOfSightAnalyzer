...
const QMatrix4x4& LineOfSightAnalyzer::Node::GetTransformation() const
{
...
void LineOfSightAnalyzer::Node::SetScale(float UniformScale)
{
...
const QQuaternion& LineOfSightAnalyzer::Node::GetRotation() const
{
    return mRotation;
}

const QVector3D& LineOfSightAnalyzer::Node::GetPosition() const
{
    return mPosition;
}

const QVector3D& LineOfSightAnalyzer::Node::GetScale() const
{
    return mScale;
}

const QMatrix3x3& LineOfSightAnalyzer::Node::GetNormalMatrix() const
{
