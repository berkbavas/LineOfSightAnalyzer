...
void LineOfSightAnalyzer::ArcballCamera::Update(float ifps)
{
    // Theta
...
void LineOfSightAnalyzer::ArcballCamera::OnMousePressed(QMouseEvent* event)
{
...
void LineOfSightAnalyzer::ArcballCamera::OnMouseReleased(QMouseEvent* event)
{
    mMouse.button = Qt::NoButton;
}

void LineOfSightAnalyzer::ArcballCamera::OnMouseMoved(QMouseEvent* event)
{
...
void LineOfSightAnalyzer::ArcballCamera::OnWheelMoved(QWheelEvent* event)
{
    mDeltaDistance += GetAdaptiveMultiplier() * Math::Sign(event->angleDelta().y());
}

float LineOfSightAnalyzer::ArcballCamera::GetAdaptiveMultiplier() const
{
