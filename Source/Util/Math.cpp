...
QQuaternion LineOfSightAnalyzer::Math::RotateX(float angleRadians)
{
    return QQuaternion::fromAxisAndAngle(QVector3D(1, 0, 0), qRadiansToDegrees(angleRadians));
}

QQuaternion LineOfSightAnalyzer::Math::RotateY(float angleRadians)
{
    return QQuaternion::fromAxisAndAngle(QVector3D(0, 1, 0), qRadiansToDegrees(angleRadians));
}

QQuaternion LineOfSightAnalyzer::Math::RotateZ(float angleRadians)
{
    return QQuaternion::fromAxisAndAngle(QVector3D(0, 0, 1), qRadiansToDegrees(angleRadians));
}

QQuaternion LineOfSightAnalyzer::Math::Invert(const QQuaternion& rotation)
{
...
QVector3D LineOfSightAnalyzer::Math::ConstructFromLatLon(float lat, float lon)
{
