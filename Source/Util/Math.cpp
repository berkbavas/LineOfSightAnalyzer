...
void LineOfSightAnalyzer::Math::GetEulerDegrees(const QQuaternion& Rotation, float& Yaw, float& Pitch, float& Roll)
{
    ...
    Roll = LineOfSightAnalyzer::Math::AngleBetween(xAxis, xAxisProj, Left);
...
QQuaternion LineOfSightAnalyzer::Math::ConstructFromEulerDegrees(float Yaw, float Pitch, float Roll)
{
...
float LineOfSightAnalyzer::Math::AngleBetween(const QVector3D& V1, const QVector3D& V2, const QVector3D& Left)
{
...
float LineOfSightAnalyzer::Math::AngleBetween(const QVector3D& V1, const QVector3D& V2)
{
    QVector3D U1 = V1.normalized();
    QVector3D U2 = V2.normalized();
...
float LineOfSightAnalyzer::Math::SignedAngleBetween(const QVector3D& V1, const QVector3D& V2, const QVector3D& Axis)
{
...
QVector3D LineOfSightAnalyzer::Math::ProjectOntoPlane(const QVector3D& Vector, const QVector3D& PlaneNormal)
{
    return Vector - QVector3D::dotProduct(Vector, PlaneNormal) * PlaneNormal;
}

QQuaternion LineOfSightAnalyzer::Math::RotationBetweenVectors(const QVector3D& V0, const QVector3D& V1)
{
...
bool LineOfSightAnalyzer::Math::IntersectRayPlane(const QVector3D& RayOrigin, const QVector3D& RayDir, const QVector3D& PlanePoint, const QVector3D& PlaneNormal, QVector3D& IntersectionPoint)
{
...
bool LineOfSightAnalyzer::Math::IntersectRaySphere(const QVector3D& RayOrigin, const QVector3D& RayDirection, const QVector3D& SphereCenter, float SphereRadius, QVector3D& OutIntersectionPoint)
{
