...
void LineOfSightAnalyzer::Logger::Log(LogLevel LogLevel, const std::string& LogMessage)
{
...
void LineOfSightAnalyzer::Logger::QtMessageOutputCallback(QtMsgType Type, const QMessageLogContext& Context, const QString& LogMessage)
{
    switch (Type)
    {
    case QtDebugMsg:
